...
project_name = _cfg.get("project_name", "EnigmaPrinter")
project_description = _cfg.get(
    "project_description",
    "<a href='https://github.com/raulcamaracarreon/EnigmaPrinter'>https://github.com/raulcamaracarreon/EnigmaPrinter</a>",
)
